...
inline Bitboard pawn_attacks(Color c, int sq) { return PawnAttacks[c][sq]; }

inline Bitboard rank_bb(int sq) { return RANK_1 << (8 * rank_of(sq)); }
inline Bitboard file_bb(int sq) { return FILE_A << file_of(sq); }
inline Bitboard between_bb(int a, int b) { return BetweenBB[a][b]; }
